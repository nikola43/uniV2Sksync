...
contract SkSyncSwapToken is BEP20 {
    using SafeMath for uint256;
    uint256 public constant maxSupply = 99_999_999e18;

    constructor() BEP20("SkSyncSwapToken", "SkSyncSwapToken") {
    ...
    function safeSkSyncSwapTokenTransfer(address _to, uint256 _amount) public onlyOwner {
