...
export interface VaultFlashLoansInterface extends utils.Interface {
  functions: {
...
export interface VaultFlashLoans extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VaultFlashLoansInterface;
