...
export interface TestERC20Permit2Interface extends utils.Interface {
  functions: {
...
export interface TestERC20Permit2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestERC20Permit2Interface;
