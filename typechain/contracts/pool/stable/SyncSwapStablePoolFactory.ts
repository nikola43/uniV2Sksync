...
export interface SyncSwapStablePoolFactoryInterface extends utils.Interface {
  functions: {
...
export interface SyncSwapStablePoolFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SyncSwapStablePoolFactoryInterface;
  ...
  functions: {
    ...
    ): Promise<[string] & { deployData: string }>;
