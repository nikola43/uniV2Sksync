...
export interface SyncSwapStablePoolInterface extends utils.Interface {
  functions: {
...
export interface SyncSwapStablePool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SyncSwapStablePoolInterface;
