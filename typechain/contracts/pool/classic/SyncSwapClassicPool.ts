...
export interface SyncSwapClassicPoolInterface extends utils.Interface {
  functions: {
...
export interface SyncSwapClassicPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SyncSwapClassicPoolInterface;
  ...
  functions: {
    ...
    getProtocolFee(
      overrides?: CallOverrides
    ): Promise<[number] & { _protocolFee: number }>;
